...
public class LevelSelect extends Scene {
   ...
   public void display (InputHandler handler) {
      ...
      GameButton level1 = new GameButton("Level1", 490, 500, 100, 100, handler);
      GameButton level2 = new GameButton("Level2", 490, 550, 100, 100, handler);
      GameButton level3 = new GameButton("Level3", 490, 600, 100, 100, handler);
      GameButton back = new GameButton("Back", 490, 650, 100, 100, handler);
